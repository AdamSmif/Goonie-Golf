...
onready var slid  := $HSlider
onready var lblzm := $zoom
onready var lblx  := $size_x
onready var lbly  := $size_y
onready var pal   := $pal
onready var palist:= $pal_list
onready var colpic:= $ColorPickerButton
onready var cursor = $Control/top/cursor

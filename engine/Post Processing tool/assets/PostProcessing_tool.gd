...
var white_balance_warm_color = preload("res://engine/Post Processing tool/assets/warm_color.res")
var white_balance_cool_color = preload("res://engine/Post Processing tool/assets/cool_color.res")
